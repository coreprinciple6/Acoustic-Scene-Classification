...
class ResNetEncoder(nn.Module):
    ...
    """
    def __init__(self, in_channels=3, blocks_sizes=[64, 128, 256, 512], deepths=[1,1,1,1],
...
def test():
    ...
    train_dataset = datasets.ImageFolder(root='E:/yoda/spectrograms/ImgsTrain', transform=transforms)
    test_dataset = datasets.ImageFolder(root='E:/yoda/spectrograms/ImgsTest', transform=transforms)

    trainset = DataLoader(train_dataset, batch_size=32, shuffle=True)
    testset = DataLoader(test_dataset, batch_size=32, shuffle=False)
